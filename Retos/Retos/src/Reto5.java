...
public class Reto5 {
    public static void main(String[] args) {
        ...
        System.out.println("Este es un programa que le dice su signo zodiacal y la descripción");
        System.out.println("Digite el mes: 1-12");
        mes=leer.nextInt();
        System.out.println("Digite el dia: 1-31");
        dia=leer.nextInt();
